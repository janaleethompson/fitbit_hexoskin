...
fitbit <- function(id, download_range = "20161105_20161205", 
  ...
  hr_file <- paste0(id, "_heartrate_seconds_", download_range, ".csv")
  fb_hr <- read.csv(hr_file)
...
heartrate_df <- function(id, filter = TRUE, 
  ...
  hexo <- hexoskin(id, fb_start, h_dir)$hr
...
hr_plot <- function(id, filter = TRUE, h_dir = "~/Desktop/plots", 
                    download_range = "20161105_20161205", 
                    fb_dir = "~/Desktop/plots") {
  
  to_plot <- heartrate_df(id, filter, h_dir, download_range, fb_dir)
...
br_plot <- function(id, fb_start = NULL, dir = "~/Desktop/plots") {
  

  df <- hexoskin(id, fb_start, dir)$breathing
...
stepcount_df <- function(id, filter = TRUE, 
  ...
  hexo <- hexoskin(id, fb_start = NULL, h_dir)$steps
...
stepcount_plot <- function(id, filter = TRUE, h_dir = "~/Desktop/plots", 
                           download_range = "20161105_20161205", 
                           fb_dir = "~/Desktop/plots") {

  to_plot <- stepcount_df(id, filter, h_dir, download_range, fb_dir)
